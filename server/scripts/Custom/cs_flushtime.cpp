...
public:
	...
	std::vector<ChatCommand> GetCommands() const override
	{
		...
		{
			{ "flushtime",          rbac::RBAC_PERM_COMMAND_ADDITEM,          false, &HandleFlushtimeCommand,          "" },
		};
		return commandTable;
	}
	...
	{
		uint32 timeInSeconds = difftime(sWorld->getWorldState(WS_ARENA_DISTRIBUTION_TIME), time(NULL));
