...
enum WorldDatabaseStatements
{
    ...
    */
	...
	// Gamble NPC
	WORLD_SEL_GAMBLE_ITEMS,
	WORLD_SEL_ITEMNAME_BYENTRY,

	// 1vs1 betting NPC
	WORLD_INS_1VS1,
	WORLD_SEL_1VS1_BYGUID,
	WORLD_UPD_1VS1_BYGUID,
	WORLD_DEL_1VS1_BYGUID,

	// Lottery Script
	WORLD_SEL_LOTTERY_REWARD,
	WORLD_SEL_LOTTERY_REWARDLIST,
	WORLD_UPD_LOTTERY_REMOVEREWARD,
	WORLD_UPD_LOTTERY_ADDREWARD,
